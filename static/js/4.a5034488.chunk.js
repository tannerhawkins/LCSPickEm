...
`,v=s.a.p`
  color: red;
  margin-top: -20px;
`;t.default=()=>{const e=Object(p.g)(),[t,i]=Object(a.useState)(),s=Object(r.b)();return Object(x.jsxs)(n.a,{title:"Sign-In",description:"Sign-In",children:[Object(x.jsx)(o.a,{}),Object(x.jsxs)(m,{children:[Object(x.jsx)(g,{children:"Sign-In"}),Object(x.jsxs)(u,{id:"signInForm",children:[Object(x.jsx)(O,{type:"email",placeholder:"Email",name:"email","data-test":"email",required:!0}),Object(x.jsx)(j,{type:"password",placeholder:"Password",name:"password","data-test":"password",required:!0}),Object(x.jsx)(v,{children:t}),Object(x.jsxs)(b,{children:[Object(x.jsx)(f,{"data-test":"sign-up",onClick:()=>e.push("/signup"),children:"Don't have an account? Sign up here"}),Object(x.jsx)(w,{type:"submit","data-test":"submit",onClick:()=>{i();const t=Object.values(document.forms.signInForm).reduce(((e,t)=>(e[t.name]=t.value,e)),{});for(var a in t)if(""===t[a])return void i("Please fill out all fields");t.email.includes("@")?l.a.signInWithEmailAndPassword(t.email,t.password).then((()=>{l.c.doc(l.a.currentUser.uid).get().then((i=>{s(Object(h.e)(i.data())),s(Object(h.a)(t.password.length)),l.b.get().then((e=>{var t,i,a;const n=e.docs.map((e=>{var t;return null===(t=e.data().games[e.data().games.length-1])||void 0===t?void 0:t.start})).reduce((e=>new Date>e?1:0));s(Object(h.c)((null===(t=e.docs[n])||void 0===t?void 0:t.data())?null===(i=e.docs[n])||void 0===i?void 0:i.data():null===(a=e.docs[0])||void 0===a?void 0:a.data()))})).then(e.push("/home"))}))})).catch((e=>{"auth/user-not-found"===e.code?i("A user with this email address does not exist"):"auth/wrong-password"===e.code?i("The password is invalid."):i(e.message)})):i("Please enter valid email address")},children:"SIGN-IN"})]})]})]})]})}}}]);
//# sourceMappingURL=4.a5034488.chunk.js.map