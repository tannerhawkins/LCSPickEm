(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[6],{49:function(A,e,i){"use strict";i.d(e,"a",(function(){return t}));const t={COLOR:{LIGHT_GREEN:"#A2E1D0",DARK_GREEN:"#6BAE9B",GREEN:"#7DCBB5",WHITE:"#e9e9ff",DARK_BLUE:"#373B53",TEAL:"#B5FFEA",GRAY:"#E5E5E5"},HEADER_HEIGHT:"80px",SIDEBAR_WIDTH:"80px",EMPTY_MODULE:{title:"",description:"",public:!0,creator:void 0,steps:[]},MOCK_MODULE:{title:"Mock Module",description:"This module is used for testing and development",public:!0,creator:"someteacherIDhere",steps:[{type:"text",data:{}},{type:"video",data:{}},{type:"quiz",data:{}}]}}},50:function(A,e,i){"use strict";i.d(e,"d",(function(){return a})),i.d(e,"b",(function(){return n})),i.d(e,"c",(function(){return r})),i.d(e,"a",(function(){return c}));var t=i(60);i(65);t.a.initializeApp({apiKey:"AIzaSyBikWf9vy86sF9wXyRjkpdrrAJaw7WoQ8M",authDomain:"ancient-path-adventures.firebaseapp.com",projectId:"ancient-path-adventures",storageBucket:"ancient-path-adventures.appspot.com",messagingSenderId:"1051282870332",appId:"1:1051282870332:web:8f7a5922db7d370e86b339",measurementId:"G-NPPQJQTEQN"});const o=t.a.firestore();var c=t.a.auth();new t.a.auth.GoogleAuthProvider;const a=o.collection("userData"),n=o.collection("classData"),r=o.collection("modules")},51:function(A,e,i){"use strict";var t=i(49);const o=i(48).a.div`
...
`;var x=({className:A})=>{const e=Object(l.c)(g.c),i=Object(l.c)(g.a);return Object(n.jsxs)(C,{className:A,children:[Object(n.jsx)(B,{}),Object(n.jsx)(h,{src:c}),Object(n.jsxs)(p,{children:[Object(n.jsx)(u,{children:e}),Object(n.jsx)(I,{children:i})]})]})},Q=(i(53),i(11));const j=t.a.header`
  display: flex;
...
`,U=Object(t.a)(x)``;e.a=()=>{const A=Object(l.b)();return Object(n.jsxs)(j,{id:"header",children:[Object(n.jsx)(O,{}),Object(n.jsxs)(b,{children:[Object(n.jsx)(U,{}),Object(n.jsxs)(R,{children:[Object(n.jsx)(m,{src:a.a}),Object(n.jsx)(f,{src:c})]}),Object(n.jsx)(s,{}),Object(n.jsx)(J,{onClick:()=>A(Object(Q.a)()),src:d.a})]})]})}},57:function(A,e,i){"use strict";i(0);var t=i(48),o=i(49),c=i(52),a=i(5),n=i(2);const r=t.a.div`
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;e.a=({className:A})=>Object(c.jsx)(a,{className:A,src:o})},59:function(A,e,i){"use strict";i.d(e,"b",(function(){return t})),i.d(e,"d",(function(){return o})),i.d(e,"a",(function(){return c})),i.d(e,"e",(function(){return a})),i.d(e,"f",(function(){return n})),i.d(e,"c",(function(){return r}));const t=A=>({type:"SET_CURRENT_STEP",payload:A}),o=A=>({type:"SET_SELECTED_MODULE",payload:A}),c=A=>({type:"ADD_STEP",payload:A}),a=A=>({type:"SET_STEPS",payload:A}),n=A=>({type:"SET_TITLE",payload:A}),r=A=>({type:"SET_DESCRIPTION",payload:A})},62:function(A,e,i){"use strict";i.d(e,"a",(function(){return t}));i(50);const t=A=>({type:"SET_CURRENT_CLASS",payload:A})},68:function(A,e,i){"use strict";i.d(e,"a",(function(){return a}));var t=i(6),o=i(11);const c=Object(t.a)((()=>o.c.getState()),(A=>A.class)),a=Object(t.a)(c,(A=>A.currentClass))},95:function(A,e,i){"use strict";i.r(e);var t=i(0),o=i(23),c=i(57),a=i(56),n=i(48),r=i(49),s=i(50),d=i(60),l=i(5),g=i(51),E=i(12),C=i(59),h=i(32),B=i(2);const p=n.a.div`
  ...
  align-items: center;
  padding: 10px;
`;var u=({id:A,type:e,handleDrag:i,handleDrop:t})=>Object(B.jsx)(p,{draggable:!0,id:A,onDragOver:A=>A.preventDefault(),onDragStart:i,onDrop:t,children:e});const I=n.a.div`
  display: flex;
  flex-direction: column;
  margin: 40px 0px;
`;var x=A=>{const e=Object(E.b)(),[i,o]=Object(t.useState)(),c=Object(E.c)(h.f),a=A=>{o(A.currentTarget.id)},n=A=>{const t=c.find((A=>A.id===parseInt(i))),o=c.find((e=>e.id===parseInt(A.currentTarget.id))),a=t.order,n=o.order,r=c.map((e=>(e.id===parseInt(i)&&(e.order=n),e.id===parseInt(A.currentTarget.id)&&(e.order=a),e)));e(Object(C.e)(r))};return Object(B.jsx)(I,{children:c.sort(((A,e)=>A.order-e.order)).map((A=>Object(B.jsx)(u,{id:parseInt(A.id),boxColor:A.color,type:A.type,handleDrag:a,handleDrop:n},parseInt(A.id))))})};const Q=n.a.div`
  background-color: white;
  border-radius: 4px;
  width: 40%;
  height: 400px;
...
`,O=n.a.div`
  width: 100%;
`;var R=A=>Object(B.jsx)(b,{style:A.style,children:Object(B.jsxs)(Q,{className:A.className,children:[Object(B.jsx)(j,{onClick:A.onClose,children:"X"}),Object(B.jsx)(O,{children:A.children})]})});const m=Object(n.a)(R)``,f=n.a.p`
  text-align: center;
`,J=n.a.div`
  display: flex;
  flex-direction: column;
...
`,U=Object(n.a)(g.a)`
  ...
  align-items: center;
  padding: 10px;
`;var Y=({className:A,onClose:e,style:i})=>{const t=Object(l.g)(),o=(Object(E.b)(),Object(E.c)(h.f),A=>{t.push(`/teacher/create-module/edit-${A}`)});return Object(B.jsxs)(m,{style:i,className:A,onClose:e,children:[Object(B.jsx)(f,{children:"Select Step to Add"}),Object(B.jsxs)(J,{children:[Object(B.jsx)(U,{onClick:()=>o("text"),children:"Text"}),Object(B.jsx)(U,{onClick:()=>o("video"),children:"Video"}),Object(B.jsx)(U,{onClick:()=>o("quiz"),children:"Quiz"})]})]})},v=i(68),G=i(62);const K=n.a.div`
  margin-top: ${r.a.HEADER_HEIGHT};
  margin-left: ${r.a.SIDEBAR_WIDTH};
  padding: 10px 50px;
`,S=n.a.p`
  line-height: 36px;
  font-size: 30px;
...
`,N=Object(n.a)(M)``,W=Object(n.a)(g.a)`
  font-size: 15px;
  height: 50px;
  padding: 0 5px;
  min-width: 120px;
...
`,L=n.a.p`
  ...
  font-weight: 600;
  margin: 0;
`;e.default=()=>{const A=Object(l.g)(),e=Object(E.b)(),[i,n]=Object(t.useState)(!1),[r,g]=Object(t.useState)(),p=Object(E.c)(h.e),u=Object(E.c)(h.f),I=Object(E.c)(v.a);Object(t.useEffect)((()=>{}),[u]);return Object(B.jsxs)(o.a,{title:"Create a Module",description:"Create a Module",children:[Object(B.jsx)(c.a,{}),Object(B.jsx)(a.a,{}),Object(B.jsx)(Y,{style:{display:i?"flex":"none"},onClose:()=>n(!1)}),Object(B.jsxs)(K,{children:[Object(B.jsx)(S,{children:"Create New Module"}),Object(B.jsx)(D,{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ac purus eget lacus pellentesque consequat. Donec commodo tincidunt lorem, c ursus accumsan eros varius vel."}),Object(B.jsxs)(F,{id:"moduleForm",children:[Object(B.jsx)(L,{children:"Module Title"}),Object(B.jsx)(V,{type:"text",id:"title",name:"title",defaultValue:null===p||void 0===p?void 0:p.title,required:!0}),Object(B.jsx)(L,{children:"Module Description"}),Object(B.jsx)(V,{type:"text",id:"description",name:"description",defaultValue:null===p||void 0===p?void 0:p.description}),Object(B.jsxs)(w,{children:[Object(B.jsx)(L,{children:"Steps - Drag to Change Order"}),Object(B.jsx)(N,{onClick:()=>{e(Object(C.f)(document.getElementById("title").value)),e(Object(C.c)(document.getElementById("description").value)),n(!0)},children:"Add Step"})]}),Object(B.jsx)(y,{children:Object(B.jsx)(x,{steps:u})}),Object(B.jsx)(H,{children:r}),Object(B.jsxs)(k,{children:[Object(B.jsx)(M,{onClick:()=>{g();const i=Object.values(document.forms.moduleForm).filter((A=>A.name)).reduce(((A,e)=>(A[e.name]=e.value,A)),{}),t={...p,title:i.title,description:i.description,creator:s.a.currentUser.uid};if(""===i.title)return void g("Please fill out module title");if(0===u.length)return void g("Please add at least one step");const o=I.students;s.c.add(t).then((A=>{s.c.doc(A.id).update({mid:A.id}),s.d.doc(s.a.currentUser.uid).update({moduleList:d.a.firestore.FieldValue.arrayUnion({mid:A.id,title:i.title,description:i.description})}).then((()=>{s.b.doc(I.cid).update({modules:d.a.firestore.FieldValue.arrayUnion(A.id)}).then(s.b.doc(null===I||void 0===I?void 0:I.cid).get().then((A=>e(Object(G.a)(A.data()))))).then((()=>{o.forEach((e=>{s.d.doc(e.uid).get().then((i=>{const t=i.data().classList,o=t.filter((A=>A.cid===I.cid))[0],c={...o,modules:[...o.modules,A.id]},a=(()=>{for(let A=0;A<t.length;A++)if(t[A].cid===o.cid)return A;return-1})();t.splice(a,1,c),s.d.doc(e.uid).update({classList:t})}))}))}))}))})).then((()=>A.push("teacher/home")))},children:"CREATE"}),Object(B.jsx)(W,{onClick:()=>A.push("teacher/home"),children:"BACK TO DASHBOARD"})]})]})]})]})}}}]);
//# sourceMappingURL=6.d10b9564.chunk.js.map