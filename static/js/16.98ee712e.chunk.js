(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[16],{127:function(t,e,A){"use strict";var a=A(66),i=A(77),o=A(25),r=A(5);const n=a.a.div`
  border-radius: 3px;
...
`;e.default=()=>{const t=Object(h.g)(),e=Object(s.b)(),A=Object(s.c)(l.a),o=(Object(s.c)(p.b),null===A||void 0===A?void 0:A.modules),d=null===A||void 0===A?void 0:A.apaModules,y=null===o||void 0===o?void 0:o.map((A=>Object(f.jsx)(x.a,{module:A,"data-test":"module-card",onClick:()=>(A=>{m.d.doc(A).get().then((A=>{e(Object(C.d)(A.data())),t.push("/teacher/create-module")}))})(A)},A))),D=null===d||void 0===d?void 0:d.map((t=>Object(f.jsx)(b.a,{module:t,"data-test":"module-card"},t)));return Object(f.jsx)(n.a,{title:"Dashboard",description:"Dashboard",children:Object(f.jsxs)(O,{children:[Object(f.jsx)(a.a,{}),Object(f.jsx)(i.a,{}),Object(f.jsx)(r.a,{}),Object(f.jsxs)(j,{children:[Object(f.jsxs)(w,{children:[Object(f.jsxs)(E,{children:[Object(f.jsx)(B,{children:"Dashboard "}),Object(f.jsx)(g.a,{})]}),A&&Object(f.jsxs)(L,{children:[Object(f.jsx)("b",{children:"Enrollment Code:"})," ",A.cid]})]}),Object(f.jsx)(v,{children:"New"}),Object(f.jsxs)(R,{children:[A&&Object(f.jsx)(I,{plusIconColor:"green",barColor:c.a.COLOR.GREEN,cardColor:c.a.COLOR.TEAL,onClick:()=>t.push("/teacher/add-module"),dataTest:"add-module",children:"Module"}),A&&Object(f.jsx)(I,{plusIconColor:"teal",barColor:c.a.COLOR.TEAL,cardColor:c.a.COLOR.GREEN,onClick:()=>t.push("/teacher/add-students"),dataTest:"add-student",children:"Students"}),Object(f.jsx)(I,{plusIconColor:"green",barColor:c.a.COLOR.GREEN,cardColor:"white",onClick:()=>t.push("/teacher/create-class"),dataTest:"add-class",children:"Class"})]}),Object(f.jsx)(v,{children:"Assigned Modules"}),Object(f.jsx)(u.a,{moduleCards:null===y||void 0===y?void 0:y.concat(D)})]})]})})}},68:function(t,e,A){"use strict";A.d(e,"b",(function(){return a})),A.d(e,"d",(function(){return i})),A.d(e,"e",(function(){return o})),A.d(e,"a",(function(){return r})),A.d(e,"h",(function(){return n})),A.d(e,"f",(function(){return d})),A.d(e,"g",(function(){return c})),A.d(e,"c",(function(){return s}));const a=t=>({type:"SET_CURRENT_STEP",payload:t}),i=t=>({type:"SET_SELECTED_MODULE",payload:t}),o=t=>({type:"SET_SELECTED_STEP",payload:t}),r=t=>({type:"ADD_STEP",payload:t}),n=t=>({type:"UPDATE_STEP",payload:t}),d=t=>({type:"SET_STEPS",payload:t}),c=t=>({type:"SET_TITLE",payload:t}),s=t=>({type:"SET_DESCRIPTION",payload:t})},87:function(t,e,A){"use strict";var a=A(2),i=A(16),o=A(66),r=A(21),n=A(30),d=A(38),c=A(25),s=A(19),l=A(5);const p=o.a.form`
  display: flex;
  flex-flow: column;
...
`;e.a=t=>{const e=Object(i.b)(),A=Object(i.c)(r.b),o=Object(i.c)(d.a);Object(a.useEffect)((()=>{}));return A[0]?Object(l.jsx)(p,{action:t.action,"data-test":"dropdown",children:Object(l.jsx)(g,{id:"services","data-test":"class",name:"services",onChange:t=>{const A=Array.from(t.target.children).filter((t=>t.selected)).map((t=>t.dataset.cid))[0];s.c.doc(A).get().then((t=>e(Object(n.a)(t.data()))))},defaultValue:null===o||void 0===o?void 0:o.cid,children:A.map((t=>Object(l.jsx)(h,{value:t.cid,"data-cid":t.cid,classItem:t,children:t.className},t.cid)))})}):Object(l.jsx)(l.Fragment,{})}},88:function(t,e,A){"use strict";var a=A(2),i=A(66),o=A(25),r=A(19),n=A(5);const d=i.a.div`
...
`,s=i.a.p`
  ...
  border-radius: 5px;
  text-transform: "capitalize";
`;e.a=t=>{const[e,A]=Object(a.useState)();return Object(a.useEffect)((()=>{e||r.d.doc(t.module).get().then((t=>{A(t.data())}))}),[]),Object(n.jsx)(d,{onClick:t.onClick,children:e?Object(n.jsxs)(n.Fragment,{children:[Object(n.jsx)(c,{"data-test":"module-title",children:e.title}),Object(n.jsx)(s,{children:e.description})]}):Object(n.jsx)(n.Fragment,{children:"Loading..."})})}},89:function(t,e,A){"use strict";var a=A(66),i=A(5);const o=a.a.div`
  display: flex;
  width: 100%;
  flex-wrap: no-wrap;
  overflow: auto;
...
`;e.a=({moduleCards:t})=>Object(i.jsx)(o,{children:t})},93:function(t,e,A){"use strict";var a=A(2),i=A(66),o=A(25),r=A(19),n=A(5);const d=i.a.div`
...
`,s=i.a.p`
  ...
  border-radius: 5px;
  text-transform: "capitalize";
`;e.a=t=>{const[e,A]=Object(a.useState)();return Object(a.useEffect)((()=>{e||r.a.doc(t.module).get().then((t=>{A(t.data())}))}),[]),Object(n.jsx)(d,{onClick:t.onClick,children:e?Object(n.jsxs)(n.Fragment,{children:[Object(n.jsx)(c,{"data-test":"module-title",children:e.title}),Object(n.jsx)(s,{children:e.description})]}):Object(n.jsx)(n.Fragment,{children:"Loading..."})})}}}]);
//# sourceMappingURL=16.98ee712e.chunk.js.map