(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[11],{117:function(A,i,t){"use strict";var e=t(2),o=t(149),a=t(150),c=t.n(a),E=t(67),g=t(66),n=t(25),C=t(5);const B=Object(g.a)(E.a)`
  height: 60px;
  width: 130px;
  margin-top: 40px;
...
`,s=g.a.div`
  ...
  align-items: center;
  max-width: 400px;
`;i.a=A=>{const[i,t]=Object(e.useState)(""),a=t=>{t.preventDefault(),A.onSubmit({body:i})};return Object(C.jsxs)("form",{onSubmit:a,"data-test":"editor",children:[Object(C.jsx)(o.CKEditor,{editor:c.a,onChange:(A,i)=>{const e=i.getData();t(e)},onReady:A=>{A.editing.view.change((i=>{i.setStyle("height","60vh",A.editing.view.document.getRoot())}))},config:{toolbar:{items:["heading","|","bold","italic","link","numberedList","bulletedList","|","indent","outdent","|","blockQuote","insertTable","mediaEmbed","|","undo","redo"],shouldNotGroupWhenFull:!0}},data:A.data}),Object(C.jsxs)(s,{children:[Object(C.jsx)(B,{type:"submit",onClick:a,"data-test":"submit",children:"Submit"}),Object(C.jsx)(B,{type:"submit",onClick:A.onCancel,children:"Cancel"})]})]})}},239:function(A,i,t){"use strict";t.r(i);t(2);var e=t(36),o=t(73),a=t(72),c=t(66),E=t(25),g=t(117),n=t(16),C=t(68),B=t(11),s=t(69),I=t(5);const h=c.a.div`
  margin-top: ${E.a.HEADER_HEIGHT};
  margin-left: ${E.a.SIDEBAR_WIDTH};
  padding: 0 50px;
`,Q=c.a.p`
  font-size: 36px;
  line-height: 43px;
...
`,r=Object(c.a)(g.a)`
  height: 500px;
`;i.default=()=>{const A=Object(n.b)(),i=Object(B.g)(),t=Object(n.c)(s.h),c=Object(n.c)(s.e);return Object(I.jsxs)(e.a,{title:"Edit Text Step",description:"Edit Text Step",children:[Object(I.jsx)(o.a,{}),Object(I.jsx)(a.a,{}),Object(I.jsxs)(h,{children:[Object(I.jsx)(Q,{children:"Edit Text"}),Object(I.jsx)(r,{onSubmit:e=>{A(Object(C.a)({type:"text",order:t.length,id:c,data:e.body})),i.push("/admin/create-module")},onCancel:()=>i.push("/admin/create-module")})]})]})}},67:function(A,i,t){"use strict";var e=t(25);const o=t(66).a.div`
...
`;var x=({className:A})=>{const i=Object(C.c)(s.c),t=Object(C.c)(s.a),e=Object(B.g)();return Object(c.jsxs)(h,{className:A,onClick:()=>e.push("/profile"),children:[Object(c.jsx)(Q,{}),Object(c.jsxs)(r,{children:[Object(c.jsx)(d,{"data-test":"display-name",children:i}),Object(c.jsx)(l,{"data-test":"account-type",children:t})]})]})},u=(t(37),t(22));const R=e.a.header`
  display: flex;
