(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[8],{100:function(A,e,i){"use strict";i.r(e);var t=i(0),o=i(23),n=i(57),a=i(56),s=i(48),c=i(49),r=i(51),g=i(2);const E=s.a.textarea`
  height: 90%;
  width: 90%;
  font-size: 45px;
`,d=s.a.textarea`
...
`,Q=Object(s.a)(r.a)`
  ...
  right: 10px;
  border-radius: 10px;
`;var b=A=>{const[e,i]=Object(t.useState)((null===A||void 0===A?void 0:A.questions[A.currentQuestion])?A.questions[A.currentQuestion].questionText:""),[o,n]=Object(t.useState)((null===A||void 0===A?void 0:A.questions[A.currentQuestion])?A.questions[A.currentQuestion].answerOptions:[{answerText:"",isCorrect:!0},{answerText:"",isCorrect:!1}]),[a,s]=Object(t.useState)([]),[c,r]=Object(t.useState)("");Object(t.useEffect)((()=>{b(o)}),[o]);const b=A=>{const e=A.map((e=>Object(g.jsx)(j,{style:{height:500/A.length+"px"},answerOption:e},`${e.answerText}${A.indexOf(e)}${e.isCorrect}`)));s(e)},j=({answerOption:A,style:e})=>{const[i,a]=Object(t.useState)(A.isCorrect);return Object(g.jsxs)(l,{style:e,children:[Object(g.jsx)(E,{type:"text",defaultValue:A.answerText,onChange:e=>{delete o[A.key],A.answerText=e.target.value;for(var i=0;i<o.length;i++)void 0===o[i]&&(o[i]=A)}}),Object(g.jsx)("input",{type:"radio",checked:i,onClick:()=>(A=>{const e=o.filter((A=>A.isCorrect));if(!e.includes(A)||1!==e.length){delete o[A.key],A.isCorrect=!A.isCorrect;for(var i=0;i<o.length;i++)void 0===o[i]&&(o[i]=A);n(o),a(A.isCorrect)}})(A),onChange:()=>null}),Object(g.jsx)(h,{onClick:()=>{o.length<3||(o.splice(o.indexOf(A),1),n(o),b(o))},children:"X"})]})};return Object(g.jsxs)(x,{children:[Object(g.jsxs)(B,{children:[Object(g.jsx)(u,{children:Object(g.jsx)(d,{id:"question",type:"text",placeholder:e})}),Object(g.jsx)(C,{children:c}),Object(g.jsx)(I,{onClick:()=>{r("");const e=Array.from(document.getElementById("answerSection").children).map((A=>A.firstChild.value)),i=document.getElementById("question").value;if(""!=i){for(let A of e)if(""==A)return void r("Please fill out all fields.");o.map((A=>A.isCorrect)).includes(!0)||r("There must be at least one correct answer"),A.onSubmit([...A.questions,{questionText:i,answerOptions:o}])}else r("Please fill out all fields.")},children:"Submit Question"}),Object(g.jsx)(Q,{onClick:()=>o.length<4?n([...o,{answerText:"",isCorrect:!1}]):null,children:"Add Answer"})]}),Object(g.jsx)(p,{id:"answerSection",children:a})]})},j=i(74),O=i(12),R=i(5),f=i(59),m=i(32);const J=s.a.div`
...
`,K=s.a.p`
  ...
  line-height: 43px;
  font-weight: 500;
`;e.default=()=>{const A=Object(O.b)(),e=Object(R.g)(),[i,s]=Object(t.useState)([]),[c,r]=Object(t.useState)(!1),E=Object(O.c)(m.d),d=Object(O.c)(m.f);return Object(g.jsxs)(o.a,{title:"Edit Quiz Step",description:"Edit Quiz Step",children:[Object(g.jsx)(n.a,{}),Object(g.jsx)(a.a,{}),Object(g.jsxs)(J,{children:[Object(g.jsx)(K,{children:"Edit Quiz"}),Object(g.jsx)(U,{onClick:()=>r(!0),children:"Add Question"}),c&&Object(g.jsx)(b,{onSubmit:A=>{s(A),r(!1)},questions:i}),i.map((A=>Object(g.jsx)(Y,{children:Object(g.jsx)(j.a,{questions:i,currentQuestion:i.indexOf(A),inEdit:!0})}))),0!=i.length&&Object(g.jsx)(G,{onClick:()=>{A(Object(f.a)({type:"quiz",order:d.length,id:E,data:{questions:i}})),e.push("/teacher/create-module")},children:"Submit"})]})]})}},49:function(A,e,i){"use strict";i.d(e,"a",(function(){return t}));const t={COLOR:{LIGHT_GREEN:"#A2E1D0",DARK_GREEN:"#6BAE9B",GREEN:"#7DCBB5",WHITE:"#e9e9ff",DARK_BLUE:"#373B53",TEAL:"#B5FFEA",GRAY:"#E5E5E5"},HEADER_HEIGHT:"80px",SIDEBAR_WIDTH:"80px",EMPTY_MODULE:{title:"",description:"",public:!0,creator:void 0,steps:[]},MOCK_MODULE:{title:"Mock Module",description:"This module is used for testing and development",public:!0,creator:"someteacherIDhere",steps:[{type:"text",data:{}},{type:"video",data:{}},{type:"quiz",data:{}}]}}},50:function(A,e,i){"use strict";i.d(e,"d",(function(){return a})),i.d(e,"b",(function(){return s})),i.d(e,"c",(function(){return c})),i.d(e,"a",(function(){return n}));var t=i(60);i(65);t.a.initializeApp({apiKey:"AIzaSyBikWf9vy86sF9wXyRjkpdrrAJaw7WoQ8M",authDomain:"ancient-path-adventures.firebaseapp.com",projectId:"ancient-path-adventures",storageBucket:"ancient-path-adventures.appspot.com",messagingSenderId:"1051282870332",appId:"1:1051282870332:web:8f7a5922db7d370e86b339",measurementId:"G-NPPQJQTEQN"});const o=t.a.firestore();var n=t.a.auth();new t.a.auth.GoogleAuthProvider;const a=o.collection("userData"),s=o.collection("classData"),c=o.collection("modules")},51:function(A,e,i){"use strict";var t=i(49);const o=i(48).a.div`
...
`;var I=({className:A})=>{const e=Object(E.c)(d.c),i=Object(E.c)(d.a);return Object(s.jsxs)(l,{className:A,children:[Object(s.jsx)(x,{}),Object(s.jsx)(h,{src:n}),Object(s.jsxs)(B,{children:[Object(s.jsx)(u,{children:e}),Object(s.jsx)(p,{children:i})]})]})},Q=(i(53),i(11));const b=t.a.header`
  display: flex;
...
`,Y=Object(t.a)(I)``;e.a=()=>{const A=Object(E.b)();return Object(s.jsxs)(b,{id:"header",children:[Object(s.jsx)(O,{}),Object(s.jsxs)(j,{children:[Object(s.jsx)(Y,{}),Object(s.jsxs)(R,{children:[Object(s.jsx)(f,{src:a.a}),Object(s.jsx)(m,{src:n})]}),Object(s.jsx)(r,{}),Object(s.jsx)(J,{onClick:()=>A(Object(Q.a)()),src:g.a})]})]})}},57:function(A,e,i){"use strict";i(0);var t=i(48),o=i(49),n=i(52),a=i(5),s=i(2);const c=t.a.div`
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,g=t.a.button`
  ...
  cursor: pointer;
  margin: 10px 0px;
`;e.a=A=>Object(n.jsxs)(n.Fragment,{children:[Object(n.jsxs)(a,{children:[Object(n.jsxs)(s,{children:[Object(n.jsxs)("span",{children:["Question ",A.currentQuestion+1]}),"/",A.questions.length]}),Object(n.jsx)(c,{children:A.questions[A.currentQuestion].questionText})]}),Object(n.jsx)(r,{children:A.questions[A.currentQuestion].answerOptions.map((e=>Object(n.jsx)(g,{onClick:()=>A.inEdit?void 0:A.handleAnswerOptionClick(e.isCorrect),style:{height:100/A.questions[A.currentQuestion].answerOptions.length+"%"},children:e.answerText},A.questions[A.currentQuestion].answerOptions.indexOf(e))))})]})}}]);
//# sourceMappingURL=8.25702ee2.chunk.js.map