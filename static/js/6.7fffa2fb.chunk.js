(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[6],{49:function(A,e,i){"use strict";i.d(e,"a",(function(){return t}));const t={COLOR:{LIGHT_GREEN:"#A2E1D0",DARK_GREEN:"#6BAE9B",GREEN:"#7DCBB5",WHITE:"#e9e9ff",DARK_BLUE:"#373B53",TEAL:"#B5FFEA",GRAY:"#E5E5E5"},HEADER_HEIGHT:"80px",SIDEBAR_WIDTH:"80px",EMPTY_MODULE:{title:"",description:"",public:!0,creator:void 0,steps:[]},MOCK_MODULE:{title:"Mock Module",description:"This module is used for testing and development",public:!0,creator:"someteacherIDhere",steps:[{type:"text",data:{}},{type:"video",data:{}},{type:"quiz",data:{}}]}}},50:function(A,e,i){"use strict";i.d(e,"d",(function(){return c})),i.d(e,"b",(function(){return n})),i.d(e,"c",(function(){return s})),i.d(e,"a",(function(){return a}));var t=i(59);i(67);t.a.initializeApp({apiKey:"AIzaSyBikWf9vy86sF9wXyRjkpdrrAJaw7WoQ8M",authDomain:"ancient-path-adventures.firebaseapp.com",projectId:"ancient-path-adventures",storageBucket:"ancient-path-adventures.appspot.com",messagingSenderId:"1051282870332",appId:"1:1051282870332:web:8f7a5922db7d370e86b339",measurementId:"G-NPPQJQTEQN"});const o=t.a.firestore();var a=t.a.auth();new t.a.auth.GoogleAuthProvider;const c=o.collection("userData"),n=o.collection("classData"),s=o.collection("modules")},51:function(A,e,i){"use strict";var t=i(49);const o=i(48).a.div`
...
`;var u=({className:A})=>{const e=Object(g.c)(l.c),i=Object(g.c)(l.a);return Object(n.jsxs)(C,{className:A,children:[Object(n.jsx)(B,{}),Object(n.jsx)(h,{src:a}),Object(n.jsxs)(p,{children:[Object(n.jsx)(I,{children:e}),Object(n.jsx)(x,{children:i})]})]})},Q=(i(54),i(11));const j=t.a.header`
  display: flex;
...
`,U=Object(t.a)(u)``;e.a=()=>{const A=Object(g.b)();return Object(n.jsxs)(j,{id:"header",children:[Object(n.jsx)(O,{}),Object(n.jsxs)(b,{children:[Object(n.jsx)(U,{}),Object(n.jsxs)(R,{children:[Object(n.jsx)(m,{src:c.a}),Object(n.jsx)(J,{src:a})]}),Object(n.jsx)(r,{}),Object(n.jsx)(f,{onClick:()=>A(Object(Q.a)()),src:d.a})]})]})}},63:function(A,e,i){"use strict";i(0);var t=i(48),o=i(49),a=i(52),c=i(5),n=i(2);const s=t.a.div`
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;e.a=({className:A})=>Object(a.jsx)(c,{className:A,src:o})},68:function(A,e,i){"use strict";i.d(e,"a",(function(){return c}));var t=i(6),o=i(11);const a=Object(t.a)((()=>o.c.getState()),(A=>A.class)),c=Object(t.a)(a,(A=>A.currentClass))},94:function(A,e,i){"use strict";i.r(e);var t=i(0),o=i(23),a=i(63),c=i(62),n=i(48),s=i(49),r=i(50),d=i(59),g=i(5),l=i(51),E=i(12),C=i(61),h=i(32),B=i(2);const p=n.a.div`
  ...
  align-items: center;
  padding: 10px;
`;var I=({id:A,type:e,handleDrag:i,handleDrop:t})=>Object(B.jsx)(p,{draggable:!0,id:A,onDragOver:A=>A.preventDefault(),onDragStart:i,onDrop:t,children:e});const x=n.a.div`
  display: flex;
  flex-direction: column;
  margin: 40px 0px;
`;var u=A=>{const e=Object(E.b)(),[i,o]=Object(t.useState)(),a=Object(E.c)(h.d),c=A=>{o(A.currentTarget.id)},n=A=>{const t=a.find((A=>A.id===parseInt(i))),o=a.find((e=>e.id===parseInt(A.currentTarget.id))),c=t.order,n=o.order,s=a.map((e=>(e.id===parseInt(i)&&(e.order=n),e.id===parseInt(A.currentTarget.id)&&(e.order=c),e)));e(Object(C.d)(s))};return Object(B.jsx)(x,{children:a.sort(((A,e)=>A.order-e.order)).map((A=>Object(B.jsx)(I,{id:parseInt(A.id),boxColor:A.color,type:A.type,handleDrag:c,handleDrop:n})))})};const Q=n.a.div`
  background-color: white;
  border-radius: 4px;
  width: 40%;
  height: 400px;
...
`,O=n.a.div`
  width: 100%;
`;var R=A=>Object(B.jsx)(b,{style:A.style,children:Object(B.jsxs)(Q,{className:A.className,children:[Object(B.jsx)(j,{onClick:A.onClose,children:"X"}),Object(B.jsx)(O,{children:A.children})]})});const m=Object(n.a)(R)``,J=n.a.p`
  text-align: center;
`,f=n.a.div`
  display: flex;
  flex-direction: column;
...
`,U=Object(n.a)(l.a)`
  ...
  align-items: center;
  padding: 10px;
`;var Y=({className:A,onClose:e,style:i})=>{const t=Object(E.b)(),o=Object(E.c)(h.d),a=A=>{const i={type:A,order:o.length,id:0===o.length?0:Math.max(...o.map((A=>A.id)))+1,data:{}};t(Object(C.a)(i)),e()};return Object(B.jsxs)(m,{style:i,className:A,onClose:e,children:[Object(B.jsx)(J,{children:"Select Step to Add"}),Object(B.jsxs)(f,{children:[Object(B.jsx)(U,{onClick:()=>a("text"),children:"Text"}),Object(B.jsx)(U,{onClick:()=>a("video"),children:"Video"}),Object(B.jsx)(U,{onClick:()=>a("quiz"),children:"Quiz"})]})]})},G=i(68),K=i(56);const v=n.a.div`
...
`,N=Object(n.a)(M)``,W=Object(n.a)(l.a)`
  font-size: 15px;
  height: 50px;
  padding: 0 5px;
  min-width: 120px;
...
`,L=n.a.p`
  ...
  font-weight: 600;
  margin: 0;
`;e.default=()=>{const A=Object(g.g)(),e=Object(E.b)(),[i,n]=Object(t.useState)(!1),[s,l]=Object(t.useState)(),C=Object(E.c)(h.c),p=Object(E.c)(h.d),I=Object(E.c)(G.a);Object(t.useEffect)((()=>{}),[p]);return Object(B.jsxs)(o.a,{title:"Create a Module",description:"Create a Module",children:[Object(B.jsx)(a.a,{}),Object(B.jsx)(c.a,{}),Object(B.jsx)(Y,{style:{display:i?"flex":"none"},onClose:()=>n(!1)}),Object(B.jsxs)(v,{children:[Object(B.jsx)(S,{children:"Create New Module"}),Object(B.jsx)(k,{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ac purus eget lacus pellentesque consequat. Donec commodo tincidunt lorem, c ursus accumsan eros varius vel."}),Object(B.jsxs)(F,{id:"moduleForm",children:[Object(B.jsx)(L,{children:"Module Title"}),Object(B.jsx)(V,{type:"text",name:"title",defaultValue:null===C||void 0===C?void 0:C.title,required:!0}),Object(B.jsx)(L,{children:"Module Description"}),Object(B.jsx)(V,{type:"text",name:"description",defaultValue:null===C||void 0===C?void 0:C.description}),Object(B.jsxs)(y,{children:[Object(B.jsx)(L,{children:"Steps - Drag to Change Order"}),Object(B.jsx)(N,{onClick:()=>n(!0),children:"Add Step"})]}),Object(B.jsx)(w,{children:Object(B.jsx)(u,{steps:p})}),Object(B.jsx)(H,{children:s}),Object(B.jsxs)(D,{children:[Object(B.jsx)(M,{onClick:()=>{l();const i=Object.values(document.forms.moduleForm).filter((A=>A.name)).reduce(((A,e)=>(A[e.name]=e.value,A)),{}),t={...C,title:i.title,description:i.description,creator:r.a.currentUser.uid};console.log(t),""!==i.title?0!==p.length?r.c.add(t).then((t=>{r.c.doc(t.id).update({mid:t.id}),r.d.doc(r.a.currentUser.uid).update({moduleList:d.a.firestore.FieldValue.arrayUnion({mid:t.id,title:i.title,description:i.description})}).then((()=>{r.b.doc(I.cid).update({modules:d.a.firestore.FieldValue.arrayUnion(t.id)}).then(r.b.doc(null===I||void 0===I?void 0:I.cid).get().then((A=>e(Object(K.a)(A.data())))))})).then((()=>A.push("teacher/home")))})):l("Please add at least one step"):l("Please fill out module title")},children:"CREATE"}),Object(B.jsx)(W,{onClick:()=>A.push("teacher/home"),children:"BACK TO DASHBOARD"})]})]})]})]})}}}]);
//# sourceMappingURL=6.7fffa2fb.chunk.js.map