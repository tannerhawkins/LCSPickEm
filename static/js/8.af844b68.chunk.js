(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[8],{49:function(A,i,e){"use strict";e.d(i,"a",(function(){return t}));const t={COLOR:{LIGHT_GREEN:"#A2E1D0",DARK_GREEN:"#6BAE9B",GREEN:"#7DCBB5",WHITE:"#e9e9ff",DARK_BLUE:"#373B53",TEAL:"#B5FFEA",GRAY:"#E5E5E5"},HEADER_HEIGHT:"80px",SIDEBAR_WIDTH:"80px",EMPTY_MODULE:{title:"",description:"",public:!0,creator:void 0,steps:[]},MOCK_MODULE:{title:"Mock Module",description:"This module is used for testing and development",public:!0,creator:"someteacherIDhere",steps:[{type:"text",data:{}},{type:"video",data:{}},{type:"quiz",data:{}}]}}},50:function(A,i,e){"use strict";e.d(i,"d",(function(){return c})),e.d(i,"b",(function(){return s})),e.d(i,"c",(function(){return n})),e.d(i,"a",(function(){return o}));var t=e(59);e(67);t.a.initializeApp({apiKey:"AIzaSyBikWf9vy86sF9wXyRjkpdrrAJaw7WoQ8M",authDomain:"ancient-path-adventures.firebaseapp.com",projectId:"ancient-path-adventures",storageBucket:"ancient-path-adventures.appspot.com",messagingSenderId:"1051282870332",appId:"1:1051282870332:web:8f7a5922db7d370e86b339",measurementId:"G-NPPQJQTEQN"});const a=t.a.firestore();var o=t.a.auth();new t.a.auth.GoogleAuthProvider;const c=a.collection("userData"),s=a.collection("classData"),n=a.collection("modules")},51:function(A,i,e){"use strict";var t=e(49);const a=e(48).a.div`
...
`;var p=({className:A})=>{const i=Object(C.c)(B.c),e=Object(C.c)(B.a);return Object(s.jsxs)(I,{className:A,children:[Object(s.jsx)(d,{}),Object(s.jsx)(h,{src:o}),Object(s.jsxs)(Q,{children:[Object(s.jsx)(l,{children:i}),Object(s.jsx)(x,{children:e})]})]})},u=(e(54),e(11));const R=t.a.header`
  display: flex;
...
`,O=Object(t.a)(p)``;i.a=()=>{const A=Object(C.b)();return Object(s.jsxs)(R,{id:"header",children:[Object(s.jsx)(j,{}),Object(s.jsxs)(m,{children:[Object(s.jsx)(O,{}),Object(s.jsxs)(J,{children:[Object(s.jsx)(b,{src:c.a}),Object(s.jsx)(Y,{src:o})]}),Object(s.jsx)(E,{}),Object(s.jsx)(U,{onClick:()=>A(Object(u.a)()),src:g.a})]})]})}},63:function(A,i,e){"use strict";e(0);var t=e(48),a=e(49),o=e(52),c=e(5),s=e(2);const n=t.a.div`
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,b=s.a.p`
  ...
  font-weight: 600;
  margin: 0;
`;i.default=()=>{const A=Object(g.g)(),i=Object(C.b)(),[e,s]=Object(t.useState)();return Object(d.jsxs)(a.a,{title:"Create a Class",description:"Create a Class",children:[Object(d.jsx)(o.a,{}),Object(d.jsx)(c.a,{}),Object(d.jsxs)(Q,{children:[Object(d.jsx)(l,{children:"Create New Class"}),Object(d.jsx)(x,{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ac purus eget lacus pellentesque consequat. Donec commodo tincidunt lorem, c ursus accumsan eros varius vel."}),Object(d.jsxs)(u,{id:"classForm",children:[Object(d.jsx)(b,{children:"Class Name"}),Object(d.jsx)(R,{type:"text",name:"name",required:!0}),Object(d.jsx)(b,{children:"Class Description"}),Object(d.jsx)(R,{type:"text",name:"description"}),Object(d.jsx)(J,{children:e}),Object(d.jsxs)(p,{children:[Object(d.jsx)(m,{onClick:()=>{s();const e=Object.values(document.forms.classForm).reduce(((A,i)=>(A[i.name]=i.value,A)),{});""!==e.name?B.b.add({className:e.name,description:e.description,students:[],enrollmentCode:"placeholdercode",modules:[]}).then((t=>{B.b.doc(t.id).update({cid:t.id}).then((()=>{B.b.doc(t.id).get().then((A=>{i(Object(I.a)(A.data()))}))})),B.d.doc(B.a.currentUser.uid).update({classList:r.a.firestore.FieldValue.arrayUnion({cid:t.id,className:e.name})}).then((()=>{B.d.doc(B.a.currentUser.uid).get().then((A=>{i(Object(h.a)(A.data()))})),A.push("teacher/home")}))})):s("Please fill out class name")},children:"CREATE"}),Object(d.jsx)(j,{onClick:()=>A.push("teacher/home"),children:"BACK TO DASHBOARD"})]})]})]})]})}}}]);
//# sourceMappingURL=8.af844b68.chunk.js.map