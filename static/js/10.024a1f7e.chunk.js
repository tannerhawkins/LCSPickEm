(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[10],{211:function(A,i,t){"use strict";t.r(i);var e=t(2),o=t(36),a=t(70),c=t(69),E=t(64),g=t(25),C=t(203),n=t(204),B=t.n(n),I=t(65),s=t(5);const h=Object(E.a)(I.a)`
  height: 60px;
  width: 130px;
  margin-top: 40px;
...
`,Q=E.a.div`
  ...
  align-items: center;
  max-width: 400px;
`;var r=A=>{const[i,t]=Object(e.useState)(""),o=t=>{t.preventDefault(),A.onSubmit({body:i})};return Object(s.jsxs)("form",{onSubmit:o,"data-test":"editor",children:[Object(s.jsx)(C.CKEditor,{editor:B.a,onChange:(A,i)=>{const e=i.getData();t(e)},onReady:A=>{A.editing.view.change((i=>{i.setStyle("height","60vh",A.editing.view.document.getRoot())}))},config:{toolbar:{items:["heading","|","bold","italic","link","numberedList","bulletedList","|","indent","outdent","|","blockQuote","insertTable","mediaEmbed","|","undo","redo"],shouldNotGroupWhenFull:!0}}}),Object(s.jsxs)(Q,{children:[Object(s.jsx)(h,{type:"submit",onClick:o,"data-test":"submit",children:"Submit"}),Object(s.jsx)(h,{type:"submit",onClick:A.onCancel,children:"Cancel"})]})]})},d=t(18),l=t(74),x=t(11),R=t(73);const u=E.a.div`
...
`,J=Object(E.a)(r)`
  height: 500px;
`;i.default=()=>{const A=Object(d.b)(),i=Object(x.g)(),t=Object(d.c)(R.g),e=Object(d.c)(R.e);return Object(s.jsxs)(o.a,{title:"Edit Text Step",description:"Edit Text Step",children:[Object(s.jsx)(a.a,{}),Object(s.jsx)(c.a,{}),Object(s.jsxs)(u,{children:[Object(s.jsx)(b,{children:"Edit Text"}),Object(s.jsx)(J,{onSubmit:o=>{A(Object(l.a)({type:"text",order:t.length,id:e,data:o.body})),i.push("/teacher/create-module")},onCancel:()=>i.push("/teacher/create-module")})]})]})}},65:function(A,i,t){"use strict";var e=t(25);const o=t(64).a.div`
...
`;var x=({className:A})=>{const i=Object(n.c)(I.c),t=Object(n.c)(I.a),e=Object(B.g)();return Object(c.jsxs)(h,{className:A,onClick:()=>e.push("/profile"),children:[Object(c.jsx)(Q,{}),Object(c.jsxs)(r,{children:[Object(c.jsx)(d,{"data-test":"display-name",children:i}),Object(c.jsx)(l,{"data-test":"account-type",children:t})]})]})},R=(t(35),t(21));const u=e.a.header`
  display: flex;
