(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[10],{120:function(A,t,e){"use strict";var i=e(2),o=e(66),n=e(25),a=e(67),s=e(5);const c=o.a.textarea`
  height: 90%;
  width: 90%;
  font-size: 45px;
`,r=o.a.textarea`
...
`,d=o.a.button`
  ...
  align-items: center;
  border: 5px solid ${n.a.COLOR.DARK_GREEN};
  margin: 10px 0px;
`,E=o.a.p`
  font-size: 20px;
  margin-left: 5px;
...
`,B=Object(o.a)(a.a)`
  ...
  right: 10px;
  border-radius: 10px;
`;t.a=A=>{const[t,e]=Object(i.useState)((null===A||void 0===A?void 0:A.questions[A.currentQuestion])?A.questions[A.currentQuestion].questionText:""),[o,n]=Object(i.useState)((null===A||void 0===A?void 0:A.questions[A.currentQuestion])?A.questions[A.currentQuestion].answerOptions:[{answerText:"",isCorrect:!0},{answerText:"",isCorrect:!1}]),[a,p]=Object(i.useState)([]),[I,Q]=Object(i.useState)("");Object(i.useEffect)((()=>{b(o)}),[o]);const b=A=>{const t=A.map((t=>Object(s.jsx)(j,{style:{height:500/A.length+"px"},answerOption:t},`${t.answerText}${A.indexOf(t)}${t.isCorrect}`)));p(t)},j=({answerOption:A,style:t})=>{const[e,a]=Object(i.useState)(A.isCorrect);return Object(s.jsxs)(d,{style:t,children:[Object(s.jsx)(c,{type:"text",defaultValue:A.answerText,onChange:t=>{delete o[A.key],A.answerText=t.target.value;for(var e=0;e<o.length;e++)void 0===o[e]&&(o[e]=A)},"data-test":"answer"}),Object(s.jsx)("input",{type:"radio",checked:e,onClick:()=>(A=>{const t=o.filter((A=>A.isCorrect));if(!t.includes(A)||1!==t.length){delete o[A.key],A.isCorrect=!A.isCorrect;for(var e=0;e<o.length;e++)void 0===o[e]&&(o[e]=A);n(o),a(A.isCorrect)}})(A),onChange:()=>null,"data-test":"is-correct"}),Object(s.jsx)(E,{onClick:()=>{o.length<3||(o.splice(o.indexOf(A),1),n(o),b(o))},children:"X"})]})};return Object(s.jsxs)(C,{children:[Object(s.jsxs)(l,{children:[Object(s.jsx)(h,{children:Object(s.jsx)(r,{id:"question",type:"text",placeholder:t,"data-test":"question"})}),Object(s.jsx)(g,{children:I}),Object(s.jsx)(u,{onClick:()=>{Q("");const t=Array.from(document.getElementById("answerSection").children).map((A=>A.firstChild.value)),e=document.getElementById("question").value;if(""!=e){for(let A of t)if(""==A)return void Q("Please fill out all fields.");o.map((A=>A.isCorrect)).includes(!0)||Q("There must be at least one correct answer"),A.onSubmit([...A.questions,{questionText:e,answerOptions:o}])}else Q("Please fill out all fields.")},"data-test":"submit-question",children:"Submit Question"}),Object(s.jsx)(B,{onClick:()=>o.length<4?n([...o,{answerText:"",isCorrect:!1}]):null,"data-test":"add-answer",children:"Add Answer"})]}),Object(s.jsx)(x,{id:"answerSection",children:a})]})}},243:function(A,t,e){"use strict";e.r(t);var i=e(2),o=e(36),n=e(72),a=e(73),s=e(66),c=e(25),r=e(67),g=e(120),d=e(94),E=e(16),C=e(11),l=e(68),h=e(69),x=e(5);const u=s.a.div`
...
`,Q=s.a.p`
  ...
  line-height: 43px;
  font-weight: 500;
`;t.default=()=>{const A=Object(E.b)(),t=Object(C.g)(),[e,s]=Object(i.useState)([]),[c,r]=Object(i.useState)(!1),b=Object(E.c)(h.e),j=Object(E.c)(h.h);return Object(x.jsxs)(o.a,{title:"Edit Quiz Step",description:"Edit Quiz Step",children:[Object(x.jsx)(n.a,{}),Object(x.jsx)(a.a,{}),Object(x.jsxs)(u,{children:[Object(x.jsx)(Q,{children:"Edit Quiz"}),Object(x.jsx)(p,{onClick:()=>r(!0),"data-test":"add-question",children:"Add Question"}),c&&Object(x.jsx)(g.a,{onSubmit:A=>{s(A),r(!1)},questions:e}),e.map((A=>Object(x.jsx)(B,{children:Object(x.jsx)(d.a,{questions:e,currentQuestion:e.indexOf(A),inEdit:!0})},e.indexOf(A)))),0!=e.length&&Object(x.jsx)(I,{onClick:()=>{A(Object(l.a)({type:"quiz",order:j.length,id:b,data:{questions:e}})),t.push("/admin/create-module")},"data-test":"submit",children:"Submit"})]})]})}},67:function(A,t,e){"use strict";var i=e(25);const o=e(66).a.div`
...
`;t.a=o},68:function(A,t,e){"use strict";e.d(t,"b",(function(){return i})),e.d(t,"d",(function(){return o})),e.d(t,"e",(function(){return n})),e.d(t,"a",(function(){return a})),e.d(t,"h",(function(){return s})),e.d(t,"f",(function(){return c})),e.d(t,"g",(function(){return r})),e.d(t,"c",(function(){return g}));const i=A=>({type:"SET_CURRENT_STEP",payload:A}),o=A=>({type:"SET_SELECTED_MODULE",payload:A}),n=A=>({type:"SET_SELECTED_STEP",payload:A}),a=A=>({type:"ADD_STEP",payload:A}),s=A=>({type:"UPDATE_STEP",payload:A}),c=A=>({type:"SET_STEPS",payload:A}),r=A=>({type:"SET_TITLE",payload:A}),g=A=>({type:"SET_DESCRIPTION",payload:A})},69:function(A,t,e){"use strict";e.d(t,"d",(function(){return a})),e.d(t,"a",(function(){return s})),e.d(t,"f",(function(){return c})),e.d(t,"g",(function(){return r})),e.d(t,"h",(function(){return g})),e.d(t,"e",(function(){return d})),e.d(t,"b",(function(){return E})),e.d(t,"c",(function(){return C}));var i=e(13),o=e(22);const n=Object(i.a)((()=>o.c.getState()),(A=>A.module)),a=Object(i.a)(n,(A=>A.inModule)),s=Object(i.a)(n,(A=>A.currentStep)),c=Object(i.a)(n,(A=>A.selectedModule)),r=Object(i.a)(n,(A=>A.selectedStep)),g=Object(i.a)(c,(A=>null===A||void 0===A?void 0:A.steps)),d=Object(i.a)(g,(A=>0===A.length?0:Math.max(...A.map((A=>A.id)))+1)),E=Object(i.a)(s,g,((A,t)=>t[A].data)),C=Object(i.a)(s,g,((A,t)=>(A+1)/(t.length+1)*100))},72:function(A,t,e){"use strict";e(2);var i=e(66),o=e(25),n=e(74),a=e(11),s=e(5);const c=i.a.div`
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;t.a=({className:A})=>{const t=Object(i.c)(a.c),e=Object(i.c)(a.a),n=Object(o.g)();return Object(c.jsxs)(r,{className:A,onClick:()=>n.push("/profile"),children:[Object(c.jsx)(g,{}),Object(c.jsxs)(d,{children:[Object(c.jsx)(E,{"data-test":"display-name",children:t}),Object(c.jsx)(C,{"data-test":"account-type",children:e})]})]})}},80:function(A,t,e){"use strict";e(2);var i=e(66),o=e.p+"static/media/default profile icon.591db299.png",n=e(5);const a=i.a.img`
  height: 50%;
  border-radius: 50%;
`;t.a=({className:A})=>Object(n.jsx)(a,{className:A,src:o})},94:function(A,t,e){"use strict";var i=e(66),o=e(25),n=e(5);const a=i.a.div`
  width: 100%;
  position: relative;
`,s=i.a.div`
  margin-bottom: 20px;
...
`,g=i.a.button`
  ...
  cursor: pointer;
  margin: 10px 0px;
`;t.a=A=>Object(n.jsxs)(n.Fragment,{children:[Object(n.jsxs)(a,{children:[Object(n.jsxs)(s,{children:[Object(n.jsxs)("span",{children:["Question ",A.currentQuestion+1]}),"/",A.questions.length]}),Object(n.jsx)(c,{"data-test":"question-text",children:A.questions[A.currentQuestion].questionText})]}),Object(n.jsx)(r,{children:A.questions[A.currentQuestion].answerOptions.map((t=>Object(n.jsx)(g,{onClick:()=>A.inEdit?void 0:A.handleAnswerOptionClick(t.isCorrect),style:{height:100/A.questions[A.currentQuestion].answerOptions.length+"%"},"data-test":"answer-text",children:t.answerText},A.questions[A.currentQuestion].answerOptions.indexOf(t))))})]})}}]);
//# sourceMappingURL=10.14698a1c.chunk.js.map