(this.webpackJsonpAncientPathAdventures=this.webpackJsonpAncientPathAdventures||[]).push([[17],{56:function(A,e,t){"use strict";t.d(e,"b",(function(){return c})),t.d(e,"c",(function(){return s})),t.d(e,"a",(function(){return i})),t.d(e,"d",(function(){return g}));const c=A=>({type:"SET_CURRENT_STEP",payload:A}),s=A=>({type:"SET_SELECTED_MODULE",payload:A}),i=A=>({type:"ADD_STEP",payload:A}),g=A=>({type:"SET_STEPS",payload:A})},69:function(A,e,t){"use strict";t.d(e,"a",(function(){return o}));var c=t(12),s=t(48),i=t(64),g=t(49),a=t(50),r=t(2);const o=A=>Object(r.jsx)(d,{selected:A.selected,"data-cid":A.value.cid,className:A.className,children:A.value.className}),C=s.a.form`
  display: flex;
  flex-flow: column;
...
`;e.b=A=>{const e=Object(c.b)();return Object(r.jsx)(C,{action:A.action,children:Object(r.jsx)(l,{id:"services",name:"services",onChange:A=>{const t=Array.from(A.target.children).filter((A=>A.selected)).map((A=>A.dataset.cid))[0];a.b.doc(t).get().then((A=>e(Object(i.a)(A.data()))))},children:A.children})})}},75:function(A,e,t){"use strict";var c=t(0),s=t(48),i=t(49),g=t(59),a=t(54),r=t(55),o=t(2);const C=s.a.div`
  display: none;
...
`,B=g.a.div`
  ...
  height: 25px;
  width: 100%;
`;var n=({children:A,className:e,plusIconColor:t,barColor:c,cardColor:s,onClick:i})=>{const g=s===o.a.COLOR.GREEN?"white":"black";return Object(C.jsxs)(l,{onClick:i,className:e,style:{backgroundColor:s},children:[Object(C.jsx)(d,{style:{color:g},children:A}),Object(C.jsx)(B,{style:{backgroundColor:c}})]})},E=t(12),Q=t(68),I=t(14),j=t(73),b=t(69),h=t(5),p=t(50),O=t(56);const U=g.a.div``,K=g.a.div`
...
`,g.a.p`
  ...
  line-height: 43px;
  font-weight: 500;
`);e.default=()=>{const A=Object(h.g)(),e=Object(E.b)(),t=Object(E.c)(Q.a),g=Object(E.c)(I.b),o=null!=g[0],l=Object(E.c)(I.b),d=t?l.filter((A=>A.cid==t.cid))[0].modules.map((A=>Object(C.jsx)(j.a,{module:A,onClick:()=>B(A)},A.mid))):void 0,B=t=>{p.c.doc(t).get().then((t=>{e(Object(O.b)(-1)),e(Object(O.c)(t.data())),A.push("/student/module")}))};return Object(c.useEffect)((()=>{}),[t]),Object(C.jsx)(r.a,{title:"Dashboard",description:"Dashboard",children:Object(C.jsxs)(U,{children:[Object(C.jsx)(s.a,{}),Object(C.jsx)(i.a,{}),Object(C.jsx)(a.a,{}),Object(C.jsxs)(K,{children:[Object(C.jsxs)(w,{children:[Object(C.jsxs)(F,{children:[Object(C.jsx)(D,{children:"Dashboard"}),g[0]&&Object(C.jsx)(b.b,{children:g.map((A=>Object(C.jsx)(b.a,{selected:A.cid===t.cid?"selected":"",value:A,classItem:A},A.cid)))})]}),Object(C.jsx)(y,{children:t&&Object(C.jsxs)("p",{children:[Object(C.jsx)("b",{children:"Enrollment Code:"})," ",t.enrollmentCode]})})]}),o?Object(C.jsxs)(C.Fragment,{children:[Object(C.jsx)(k,{children:"Assigned Modules"}),Object(C.jsx)(x,{children:d})]}):Object(C.jsx)("p",{children:"You have not been assigned to a class, please talk to your teacher"})]})]})})}}}]);
//# sourceMappingURL=17.3b5c5fca.chunk.js.map